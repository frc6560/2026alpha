...
public class VisionSubsystem extends SubsystemBase{
    ...
    public VisionSubsystem(SwerveSubsystem drivebase, String name, Pose3d cameraPose) {
    ...
    @Override
    /** Updates our standard deviation based upon a couple heuristics. And FINALLY uses gyro rotation properly! */
